...
func TestLetStatements(t *testing.T) {
	...
	if len(program.Statements) != 3 {
		t.Fatalf("program.Statements has the wrong number of statements. Expected 3, got %d", len(program.Statements))
	}
...
func testLetStatement(t *testing.T, s ast.Statement, name string) bool {
	...
	// define statement with assertion that s is a pointer to a LetStatement instance
...
func TestReturnStatements(t *testing.T) {
	...
	if len(program.Statements) != 3 {
		t.Fatalf("program.Statements does not contain expected 3 statements, got %d", len(program.Statements))
	}
